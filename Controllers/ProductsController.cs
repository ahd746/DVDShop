...
namespace DVDShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DVDShopContext context)
        {
            _context = context;
        }
        ...
        {
            var dVDShopContext = _context.Product.Include(p => p.Category);
            return View(await dVDShopContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Description,Price,Year,CategoryId")] Product product)
        {
